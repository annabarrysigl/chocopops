function init()
{
    ...
    for (let index = 0; index < noGround.length; index++) {
        const element = noGround[index];
        if (element[0] == 60 && element[1] == 0)
        {
    ...
    light1 = new Light("sun", 0xffffff, "0,0,440");
    scene.add(light1);
}
...
{
    pointLight = new THREE.PointLight(color, 400, 1650);
